...
object GL:
  ...
  def glScissor(x: GLint, y: GLint, width: GLsizei, height: GLsizei): Unit =
    extern
  ...
  def glViewport(x: GLint, y: GLint, width: GLsizei, height: GLsizei): Unit =
    extern
  ...
  def glRotated(angle: GLdouble, x: GLdouble, y: GLdouble, z: GLdouble): Unit =
    extern
  def glRotatef(angle: GLfloat, x: GLfloat, y: GLfloat, z: GLfloat): Unit =
    extern
  ...
  def glVertex4d(x: GLdouble, y: GLdouble, z: GLdouble, w: GLdouble): Unit =
    extern
  ...
  def glColor4b(red: GLbyte, green: GLbyte, blue: GLbyte, alpha: GLbyte): Unit =
    extern
  def glColor4d(
      red: GLdouble,
      green: GLdouble,
  ...
  def glColor4i(red: GLint, green: GLint, blue: GLint, alpha: GLint): Unit =
    extern
  def glColor4s(
      red: GLshort,
      green: GLshort,
  ...
  def glTexCoord4d(s: GLdouble, t: GLdouble, r: GLdouble, q: GLdouble): Unit =
    extern
  def glTexCoord4f(s: GLfloat, t: GLfloat, r: GLfloat, q: GLfloat): Unit =
    extern
  def glTexCoord4i(s: GLint, t: GLint, r: GLint, q: GLint): Unit = extern
  def glTexCoord4s(s: GLshort, t: GLshort, r: GLshort, q: GLshort): Unit =
    extern
  ...
  def glRasterPos4d(x: GLdouble, y: GLdouble, z: GLdouble, w: GLdouble): Unit =
    extern
  def glRasterPos4f(x: GLfloat, y: GLfloat, z: GLfloat, w: GLfloat): Unit =
    extern
  def glRasterPos4i(x: GLint, y: GLint, z: GLint, w: GLint): Unit = extern
  def glRasterPos4s(x: GLshort, y: GLshort, z: GLshort, w: GLshort): Unit =
    extern
  ...
  def glRectd(x1: GLdouble, y1: GLdouble, x2: GLdouble, y2: GLdouble): Unit =
    extern
  ...
  def glNormalPointer(type_ : GLenum, stride: GLsizei, ptr: Ptr[Byte]): Unit =
    extern
  def glColorPointer(
      size: GLint,
      type_ : GLenum,
  ...
  def glIndexPointer(type_ : GLenum, stride: GLsizei, ptr: Ptr[Byte]): Unit =
    extern
  ...
  def glLightfv(light: GLenum, pname: GLenum, params: Ptr[GLfloat]): Unit =
    extern
  def glLightiv(light: GLenum, pname: GLenum, params: Ptr[GLint]): Unit = extern
  def glGetLightfv(light: GLenum, pname: GLenum, params: Ptr[GLfloat]): Unit =
    extern
  def glGetLightiv(light: GLenum, pname: GLenum, params: Ptr[GLint]): Unit =
    extern
  ...
  def glMaterialfv(face: GLenum, pname: GLenum, params: Ptr[GLfloat]): Unit =
    extern
  def glMaterialiv(face: GLenum, pname: GLenum, params: Ptr[GLint]): Unit =
    extern
  def glGetMaterialfv(face: GLenum, pname: GLenum, params: Ptr[GLfloat]): Unit =
    extern
  def glGetMaterialiv(face: GLenum, pname: GLenum, params: Ptr[GLint]): Unit =
    extern
  ...
  def glPixelMapfv(map: GLenum, mapsize: GLsizei, values: Ptr[GLfloat]): Unit =
    extern
  def glPixelMapuiv(map: GLenum, mapsize: GLsizei, values: Ptr[GLuint]): Unit =
    extern
  def glPixelMapusv(
      map: GLenum,
      mapsize: GLsizei,
  ...
  def glTexGendv(coord: GLenum, pname: GLenum, params: Ptr[GLdouble]): Unit =
    extern
  def glTexGenfv(coord: GLenum, pname: GLenum, params: Ptr[GLfloat]): Unit =
    extern
  def glTexGeniv(coord: GLenum, pname: GLenum, params: Ptr[GLint]): Unit =
    extern
  def glGetTexGendv(coord: GLenum, pname: GLenum, params: Ptr[GLdouble]): Unit =
    extern
  def glGetTexGenfv(coord: GLenum, pname: GLenum, params: Ptr[GLfloat]): Unit =
    extern
  def glGetTexGeniv(coord: GLenum, pname: GLenum, params: Ptr[GLint]): Unit =
    extern
  ...
  def glTexEnvfv(target: GLenum, pname: GLenum, params: Ptr[GLfloat]): Unit =
    extern
  def glTexEnviv(target: GLenum, pname: GLenum, params: Ptr[GLint]): Unit =
    extern
  def glGetTexEnvfv(target: GLenum, pname: GLenum, params: Ptr[GLfloat]): Unit =
    extern
  def glGetTexEnviv(target: GLenum, pname: GLenum, params: Ptr[GLint]): Unit =
    extern
  def glTexParameterf(target: GLenum, pname: GLenum, param: GLfloat): Unit =
    extern
  def glTexParameteri(target: GLenum, pname: GLenum, param: GLint): Unit =
    extern
  ...
  type PFNGLDRAWRANGEELEMENTSPROC =
    CFuncPtr6[GLenum, GLuint, GLuint, GLsizei, GLenum, Ptr[Byte], Unit]
  ...
  def glGetHistogramParameterfv(
      target: GLenum,
      pname: GLenum,
      params: Ptr[GLfloat]
  ): Unit = extern
  def glGetHistogramParameteriv(
      target: GLenum,
      pname: GLenum,
      params: Ptr[GLint]
  ): Unit = extern
  def glMinmax(target: GLenum, internalformat: GLenum, sink: GLboolean): Unit =
    extern
  ...
  def glGetMinmaxParameterfv(
      target: GLenum,
      pname: GLenum,
      params: Ptr[GLfloat]
  ): Unit = extern
  def glGetMinmaxParameteriv(
      target: GLenum,
      pname: GLenum,
      params: Ptr[GLint]
  ): Unit = extern
  ...
  def glMultiTexCoord3i(target: GLenum, s: GLint, t: GLint, r: GLint): Unit =
    extern
  ...
  type PFNGLCOMPRESSEDTEXIMAGE2DPROC =
    CFuncPtr8[GLenum, GLint, GLenum, GLsizei, GLsizei, GLint, GLsizei, Ptr[
      Byte
    ], Unit]
  ...
  type PFNGLGETCOMPRESSEDTEXIMAGEPROC =
    CFuncPtr3[GLenum, GLint, Ptr[Byte], Unit]
  ...
  def glMultiTexCoord2dARB(target: GLenum, s: GLdouble, t: GLdouble): Unit =
    extern
  def glMultiTexCoord2dvARB(target: GLenum, v: Ptr[GLdouble]): Unit = extern
  def glMultiTexCoord2fARB(target: GLenum, s: GLfloat, t: GLfloat): Unit =
    extern
  ...
  def glMultiTexCoord2sARB(target: GLenum, s: GLshort, t: GLshort): Unit =
    extern
  def glMultiTexCoord2svARB(target: GLenum, v: Ptr[GLshort]): Unit = extern
  def glMultiTexCoord3dARB(
      target: GLenum,
      s: GLdouble,
      t: GLdouble,
      r: GLdouble
  ...
  def glMultiTexCoord3iARB(target: GLenum, s: GLint, t: GLint, r: GLint): Unit =
    extern
  def glMultiTexCoord3ivARB(target: GLenum, v: Ptr[GLint]): Unit = extern
  def glMultiTexCoord3sARB(
      target: GLenum,
      s: GLshort,
      t: GLshort,
      r: GLshort
  ...
  type PFNGLBLENDFUNCSEPARATEPROC =
    CFuncPtr4[GLenum, GLenum, GLenum, GLenum, Unit]
  type PFNGLMULTIDRAWARRAYSPROC =
    CFuncPtr4[GLenum, Ptr[GLint], Ptr[GLsizei], GLsizei, Unit]
  type PFNGLMULTIDRAWELEMENTSPROC =
    CFuncPtr5[GLenum, Ptr[GLsizei], GLenum, Ptr[Ptr[Byte]], GLsizei, Unit]
  ...
  type PFNGLSECONDARYCOLOR3USPROC =
    CFuncPtr3[GLushort, GLushort, GLushort, Unit]
  type PFNGLSECONDARYCOLOR3USVPROC = CFuncPtr1[Ptr[GLushort], Unit]
  type PFNGLSECONDARYCOLORPOINTERPROC =
    CFuncPtr4[GLint, GLenum, GLsizei, Ptr[Byte], Unit]
  ...
  def glSecondaryColor3b(red: GLbyte, green: GLbyte, blue: GLbyte): Unit =
    extern
  def glSecondaryColor3bv(v: Ptr[GLbyte]): Unit = extern
  def glSecondaryColor3d(red: GLdouble, green: GLdouble, blue: GLdouble): Unit =
    extern
  def glSecondaryColor3dv(v: Ptr[GLdouble]): Unit = extern
  def glSecondaryColor3f(red: GLfloat, green: GLfloat, blue: GLfloat): Unit =
    extern
  ...
  def glSecondaryColor3s(red: GLshort, green: GLshort, blue: GLshort): Unit =
    extern
  def glSecondaryColor3sv(v: Ptr[GLshort]): Unit = extern
  def glSecondaryColor3ub(red: GLubyte, green: GLubyte, blue: GLubyte): Unit =
    extern
  def glSecondaryColor3ubv(v: Ptr[GLubyte]): Unit = extern
  def glSecondaryColor3ui(red: GLuint, green: GLuint, blue: GLuint): Unit =
    extern
  def glSecondaryColor3uiv(v: Ptr[GLuint]): Unit = extern
  def glSecondaryColor3us(
      red: GLushort,
      green: GLushort,
      blue: GLushort
  ): Unit = extern
  ...
  type PFNGLBUFFERDATAPROC =
    CFuncPtr4[GLenum, GLsizeiptr, Ptr[Byte], GLenum, Unit]
  type PFNGLBUFFERSUBDATAPROC =
    CFuncPtr4[GLenum, GLintptr, GLsizeiptr, Ptr[Byte], Unit]
  type PFNGLGETBUFFERSUBDATAPROC =
    CFuncPtr4[GLenum, GLintptr, GLsizeiptr, Ptr[Byte], Unit]
  ...
  type PFNGLGETBUFFERPARAMETERIVPROC =
    CFuncPtr3[GLenum, GLenum, Ptr[GLint], Unit]
  type PFNGLGETBUFFERPOINTERVPROC =
    CFuncPtr3[GLenum, GLenum, Ptr[Ptr[Byte]], Unit]
  ...
  def glGetQueryiv(target: GLenum, pname: GLenum, params: Ptr[GLint]): Unit =
    extern
  def glGetQueryObjectiv(id: GLuint, pname: GLenum, params: Ptr[GLint]): Unit =
    extern
  ...
  type PFNGLSTENCILFUNCSEPARATEPROC =
    CFuncPtr4[GLenum, GLenum, GLint, GLuint, Unit]
  ...
  type PFNGLBINDATTRIBLOCATIONPROC =
    CFuncPtr3[GLuint, GLuint, Ptr[GLchar], Unit]
  ...
  type PFNGLGETACTIVEATTRIBPROC = CFuncPtr7[GLuint, GLuint, GLsizei, Ptr[
    GLsizei
  ], Ptr[GLint], Ptr[GLenum], Ptr[GLchar], Unit]
  type PFNGLGETACTIVEUNIFORMPROC = CFuncPtr7[GLuint, GLuint, GLsizei, Ptr[
    GLsizei
  ], Ptr[GLint], Ptr[GLenum], Ptr[GLchar], Unit]
  type PFNGLGETATTACHEDSHADERSPROC =
    CFuncPtr4[GLuint, GLsizei, Ptr[GLsizei], Ptr[GLuint], Unit]
  ...
  type PFNGLGETPROGRAMINFOLOGPROC =
    CFuncPtr4[GLuint, GLsizei, Ptr[GLsizei], Ptr[GLchar], Unit]
  ...
  type PFNGLGETVERTEXATTRIBDVPROC =
    CFuncPtr3[GLuint, GLenum, Ptr[GLdouble], Unit]
  type PFNGLGETVERTEXATTRIBFVPROC =
    CFuncPtr3[GLuint, GLenum, Ptr[GLfloat], Unit]
  type PFNGLGETVERTEXATTRIBIVPROC = CFuncPtr3[GLuint, GLenum, Ptr[GLint], Unit]
  type PFNGLGETVERTEXATTRIBPOINTERVPROC =
    CFuncPtr3[GLuint, GLenum, Ptr[Ptr[Byte]], Unit]
  ...
  type PFNGLSHADERSOURCEPROC =
    CFuncPtr4[GLuint, GLsizei, Ptr[Ptr[GLchar]], Ptr[GLint], Unit]
  ...
  type PFNGLUNIFORM4FPROC =
    CFuncPtr5[GLint, GLfloat, GLfloat, GLfloat, GLfloat, Unit]
  ...
  type PFNGLUNIFORMMATRIX2FVPROC =
    CFuncPtr4[GLint, GLsizei, GLboolean, Ptr[GLfloat], Unit]
  ...
  type PFNGLVERTEXATTRIB3DPROC =
    CFuncPtr4[GLuint, GLdouble, GLdouble, GLdouble, Unit]
  type PFNGLVERTEXATTRIB3DVPROC = CFuncPtr2[GLuint, Ptr[GLdouble], Unit]
  type PFNGLVERTEXATTRIB3FPROC =
    CFuncPtr4[GLuint, GLfloat, GLfloat, GLfloat, Unit]
  type PFNGLVERTEXATTRIB3FVPROC = CFuncPtr2[GLuint, Ptr[GLfloat], Unit]
  type PFNGLVERTEXATTRIB3SPROC =
    CFuncPtr4[GLuint, GLshort, GLshort, GLshort, Unit]
  ...
  type PFNGLVERTEXATTRIB4NUBPROC =
    CFuncPtr5[GLuint, GLubyte, GLubyte, GLubyte, GLubyte, Unit]
  ...
  type PFNGLVERTEXATTRIB4DPROC =
    CFuncPtr5[GLuint, GLdouble, GLdouble, GLdouble, GLdouble, Unit]
  type PFNGLVERTEXATTRIB4DVPROC = CFuncPtr2[GLuint, Ptr[GLdouble], Unit]
  type PFNGLVERTEXATTRIB4FPROC =
    CFuncPtr5[GLuint, GLfloat, GLfloat, GLfloat, GLfloat, Unit]
  ...
  type PFNGLVERTEXATTRIB4SPROC =
    CFuncPtr5[GLuint, GLshort, GLshort, GLshort, GLshort, Unit]
  ...
  type PFNGLVERTEXATTRIBPOINTERPROC =
    CFuncPtr6[GLuint, GLint, GLenum, GLboolean, GLsizei, Ptr[Byte], Unit]
   ...
   * OpenGL 3.0
   */
  type PFNGLCOLORMASKIPROC =
    CFuncPtr5[GLuint, GLboolean, GLboolean, GLboolean, GLboolean, Unit]
  ...
  type PFNGLBINDBUFFERRANGEPROC =
    CFuncPtr5[GLenum, GLuint, GLuint, GLintptr, GLsizeiptr, Unit]
  type PFNGLBINDBUFFERBASEPROC = CFuncPtr3[GLenum, GLuint, GLuint, Unit]
  type PFNGLTRANSFORMFEEDBACKVARYINGSPROC =
    CFuncPtr4[GLuint, GLsizei, Ptr[Ptr[GLchar]], GLenum, Unit]
  type PFNGLGETTRANSFORMFEEDBACKVARYINGPROC =
    CFuncPtr7[GLuint, GLuint, GLsizei, Ptr[GLsizei], Ptr[GLsizei], Ptr[
      GLenum
    ], Ptr[GLchar], Unit]
  ...
  type PFNGLVERTEXATTRIBI4IPROC =
    CFuncPtr5[GLuint, GLint, GLint, GLint, GLint, Unit]
  ...
  type PFNGLVERTEXATTRIBI3UIPROC =
    CFuncPtr4[GLuint, GLuint, GLuint, GLuint, Unit]
  type PFNGLVERTEXATTRIBI4UIPROC =
    CFuncPtr5[GLuint, GLuint, GLuint, GLuint, GLuint, Unit]
  ...
  type PFNGLBINDFRAGDATALOCATIONPROC =
    CFuncPtr3[GLuint, GLuint, Ptr[GLchar], Unit]
  ...
  type PFNGLUNIFORM4UIPROC =
    CFuncPtr5[GLint, GLuint, GLuint, GLuint, GLuint, Unit]
  ...
  type PFNGLGETTEXPARAMETERIUIVPROC =
    CFuncPtr3[GLenum, GLenum, Ptr[GLuint], Unit]
  ...
  type PFNGLRENDERBUFFERSTORAGEPROC =
    CFuncPtr4[GLenum, GLenum, GLsizei, GLsizei, Unit]
  ...
  type PFNGLFRAMEBUFFERTEXTURE1DPROC =
    CFuncPtr5[GLenum, GLenum, GLenum, GLuint, GLint, Unit]
  type PFNGLFRAMEBUFFERTEXTURE2DPROC =
    CFuncPtr5[GLenum, GLenum, GLenum, GLuint, GLint, Unit]
  type PFNGLFRAMEBUFFERTEXTURE3DPROC =
    CFuncPtr6[GLenum, GLenum, GLenum, GLuint, GLint, GLint, Unit]
  type PFNGLFRAMEBUFFERRENDERBUFFERPROC =
    CFuncPtr4[GLenum, GLenum, GLenum, GLuint, Unit]
  type PFNGLGETFRAMEBUFFERATTACHMENTPARAMETERIVPROC =
    CFuncPtr4[GLenum, GLenum, GLenum, Ptr[GLint], Unit]
  type PFNGLGENERATEMIPMAPPROC = CFuncPtr1[GLenum, Unit]
  type PFNGLBLITFRAMEBUFFERPROC = CFuncPtr10[
    GLint,
    GLint,
    GLint,
    GLint,
  ...
  type PFNGLRENDERBUFFERSTORAGEMULTISAMPLEPROC =
    CFuncPtr5[GLenum, GLsizei, GLenum, GLsizei, GLsizei, Unit]
  type PFNGLFRAMEBUFFERTEXTURELAYERPROC =
    CFuncPtr5[GLenum, GLenum, GLuint, GLint, GLint, Unit]
  type PFNGLMAPBUFFERRANGEPROC =
    CFuncPtr4[GLenum, GLintptr, GLsizeiptr, GLbitfield, Unit]
  type PFNGLFLUSHMAPPEDBUFFERRANGEPROC =
    CFuncPtr3[GLenum, GLintptr, GLsizeiptr, Unit]
  ...
  def glGetIntegeri_v(target: GLenum, index: GLuint, data: Ptr[GLint]): Unit =
    extern
  ...
  def glBindBufferBase(target: GLenum, index: GLuint, buffer: GLuint): Unit =
    extern
  def glTransformFeedbackVaryings(
      program: GLuint,
      count: GLsizei,
      varyings: Ptr[Ptr[GLchar]],
      bufferMode: GLenum
  ): Unit = extern
  ...
  def glVertexAttribI3i(index: GLuint, x: GLint, y: GLint, z: GLint): Unit =
    extern
  ...
  def glVertexAttribI3ui(index: GLuint, x: GLuint, y: GLuint, z: GLuint): Unit =
    extern
  ...
  def glUniform3ui(location: GLint, v0: GLuint, v1: GLuint, v2: GLuint): Unit =
    extern
  def glUniform4ui(
      location: GLint,
      v0: GLuint,
  ...
  def glUniform1uiv(location: GLint, count: GLsizei, value: Ptr[GLuint]): Unit =
    extern
  def glUniform2uiv(location: GLint, count: GLsizei, value: Ptr[GLuint]): Unit =
    extern
  def glUniform3uiv(location: GLint, count: GLsizei, value: Ptr[GLuint]): Unit =
    extern
  def glUniform4uiv(location: GLint, count: GLsizei, value: Ptr[GLuint]): Unit =
    extern
  ...
  def glDeleteRenderbuffers(n: GLsizei, renderbuffers: Ptr[GLuint]): Unit =
    extern
  ...
  type PFNGLDRAWARRAYSINSTANCEDPROC =
    CFuncPtr4[GLenum, GLint, GLsizei, GLsizei, Unit]
  type PFNGLDRAWELEMENTSINSTANCEDPROC =
    CFuncPtr5[GLenum, GLsizei, GLenum, Ptr[Byte], GLsizei, Unit]
  ...
  type PFNGLCOPYBUFFERSUBDATAPROC =
    CFuncPtr5[GLenum, GLenum, GLintptr, GLintptr, GLsizeiptr, Unit]
  type PFNGLGETUNIFORMINDICESPROC =
    CFuncPtr4[GLuint, GLsizei, Ptr[Ptr[GLchar]], Ptr[GLuint], Unit]
  type PFNGLGETACTIVEUNIFORMSIVPROC =
    CFuncPtr5[GLuint, GLsizei, Ptr[GLuint], GLenum, Ptr[GLint], Unit]
  type PFNGLGETACTIVEUNIFORMNAMEPROC =
    CFuncPtr5[GLuint, GLuint, GLsizei, Ptr[GLsizei], Ptr[GLchar], Unit]
  type PFNGLGETUNIFORMBLOCKINDEXPROC = CFuncPtr2[GLuint, Ptr[GLchar], GLuint]
  type PFNGLGETACTIVEUNIFORMBLOCKIVPROC =
    CFuncPtr4[GLuint, GLuint, GLenum, Ptr[GLint], Unit]
  ...
  def glGetActiveUniformName(
      ...
      bufSize: GLsizei,
      length: Ptr[GLsizei],
      uniformName: Ptr[GLchar]
  ): Unit = extern
  def glGetUniformBlockIndex(
      program: GLuint,
      uniformBlockName: Ptr[GLchar]
  ): GLuint = extern
   ...
   * OpenGL 3.2
   */
  type PFNGLDRAWELEMENTSBASEVERTEXPROC =
    CFuncPtr5[GLenum, GLsizei, GLenum, Ptr[Byte], GLint, Unit]
  type PFNGLDRAWRANGEELEMENTSBASEVERTEXPROC =
    CFuncPtr7[GLenum, GLuint, GLuint, GLsizei, GLenum, Ptr[Byte], GLint, Unit]
  type PFNGLDRAWELEMENTSINSTANCEDBASEVERTEXPROC =
    CFuncPtr6[GLenum, GLsizei, GLenum, Ptr[Byte], GLsizei, GLint, Unit]
  type PFNGLMULTIDRAWELEMENTSBASEVERTEXPROC = CFuncPtr6[GLenum, Ptr[
    GLsizei
  ], GLenum, Ptr[Ptr[Byte]], GLsizei, Ptr[GLint], Unit]
  ...
  type PFNGLGETSYNCIVPROC =
    CFuncPtr5[GLsync, GLenum, GLsizei, Ptr[GLsizei], Ptr[GLint], Unit]
  type PFNGLGETINTEGER64I_VPROC = CFuncPtr3[GLenum, GLuint, Ptr[GLint64], Unit]
  type PFNGLGETBUFFERPARAMETERI64VPROC =
    CFuncPtr3[GLenum, GLenum, Ptr[GLint64], Unit]
  type PFNGLFRAMEBUFFERTEXTUREPROC =
    CFuncPtr4[GLenum, GLenum, GLuint, GLint, Unit]
  type PFNGLTEXIMAGE2DMULTISAMPLEPROC =
    CFuncPtr6[GLenum, GLsizei, GLenum, GLsizei, GLsizei, GLboolean, Unit]
  type PFNGLTEXIMAGE3DMULTISAMPLEPROC = CFuncPtr7[
    GLenum,
    GLsizei,
    GLenum,
    GLsizei,
  ...
  def glWaitSync(sync: GLsync, flags: GLbitfield, timeout: GLuint64): Unit =
    extern
   ...
   * OpenGL 3.3
   */
  type PFNGLBINDFRAGDATALOCATIONINDEXEDPROC =
    CFuncPtr4[GLuint, GLuint, GLuint, Ptr[GLchar], Unit]
  ...
  type PFNGLSAMPLERPARAMETERFVPROC =
    CFuncPtr3[GLuint, GLenum, Ptr[GLfloat], Unit]
  type PFNGLSAMPLERPARAMETERIIVPROC =
    CFuncPtr3[GLuint, GLenum, Ptr[GLint], Unit]
  type PFNGLSAMPLERPARAMETERIUIVPROC =
    CFuncPtr3[GLuint, GLenum, Ptr[GLuint], Unit]
  type PFNGLGETSAMPLERPARAMETERIVPROC =
    CFuncPtr3[GLuint, GLenum, Ptr[GLint], Unit]
  type PFNGLGETSAMPLERPARAMETERIIVPROC =
    CFuncPtr3[GLuint, GLenum, Ptr[GLint], Unit]
  type PFNGLGETSAMPLERPARAMETERFVPROC =
    CFuncPtr3[GLuint, GLenum, Ptr[GLfloat], Unit]
  type PFNGLGETSAMPLERPARAMETERIUIVPROC =
    CFuncPtr3[GLuint, GLenum, Ptr[GLuint], Unit]
  type PFNGLQUERYCOUNTERPROC = CFuncPtr2[GLuint, GLenum, Unit]
  type PFNGLGETQUERYOBJECTI64VPROC =
    CFuncPtr3[GLuint, GLenum, Ptr[GLint64], Unit]
  type PFNGLGETQUERYOBJECTUI64VPROC =
    CFuncPtr3[GLuint, GLenum, Ptr[GLuint64], Unit]
  type PFNGLVERTEXATTRIBDIVISORPROC = CFuncPtr2[GLuint, GLuint, Unit]
  type PFNGLVERTEXATTRIBP1UIPROC =
    CFuncPtr4[GLuint, GLenum, GLboolean, GLuint, Unit]
  type PFNGLVERTEXATTRIBP1UIVPROC =
    CFuncPtr4[GLuint, GLenum, GLboolean, Ptr[GLuint], Unit]
  type PFNGLVERTEXATTRIBP2UIPROC =
    CFuncPtr4[GLuint, GLenum, GLboolean, GLuint, Unit]
  type PFNGLVERTEXATTRIBP2UIVPROC =
    CFuncPtr4[GLuint, GLenum, GLboolean, Ptr[GLuint], Unit]
  type PFNGLVERTEXATTRIBP3UIPROC =
    CFuncPtr4[GLuint, GLenum, GLboolean, GLuint, Unit]
  type PFNGLVERTEXATTRIBP3UIVPROC =
    CFuncPtr4[GLuint, GLenum, GLboolean, Ptr[GLuint], Unit]
  type PFNGLVERTEXATTRIBP4UIPROC =
    CFuncPtr4[GLuint, GLenum, GLboolean, GLuint, Unit]
  type PFNGLVERTEXATTRIBP4UIVPROC =
    CFuncPtr4[GLuint, GLenum, GLboolean, Ptr[GLuint], Unit]
  ...
  def glSamplerParameteri(sampler: GLuint, pname: GLenum, param: GLint): Unit =
    extern
  ...
  type PFNGLBLENDFUNCSEPARATEIPROC =
    CFuncPtr5[GLuint, GLenum, GLenum, GLenum, GLenum, Unit]
  type PFNGLDRAWARRAYSINDIRECTPROC = CFuncPtr2[GLenum, Ptr[Byte], Unit]
  type PFNGLDRAWELEMENTSINDIRECTPROC =
    CFuncPtr3[GLenum, GLenum, Ptr[Byte], Unit]
  ...
  type PFNGLUNIFORM4DPROC =
    CFuncPtr5[GLint, GLdouble, GLdouble, GLdouble, GLdouble, Unit]
  ...
  type PFNGLUNIFORMMATRIX2DVPROC =
    CFuncPtr4[GLint, GLsizei, GLboolean, Ptr[GLdouble], Unit]
  type PFNGLUNIFORMMATRIX3DVPROC =
    CFuncPtr4[GLint, GLsizei, GLboolean, Ptr[GLdouble], Unit]
  type PFNGLUNIFORMMATRIX4DVPROC =
    CFuncPtr4[GLint, GLsizei, GLboolean, Ptr[GLdouble], Unit]
  type PFNGLUNIFORMMATRIX2X3DVPROC =
    CFuncPtr4[GLint, GLsizei, GLboolean, Ptr[GLdouble], Unit]
  type PFNGLUNIFORMMATRIX2X4DVPROC =
    CFuncPtr4[GLint, GLsizei, GLboolean, Ptr[GLdouble], Unit]
  type PFNGLUNIFORMMATRIX3X2DVPROC =
    CFuncPtr4[GLint, GLsizei, GLboolean, Ptr[GLdouble], Unit]
  type PFNGLUNIFORMMATRIX3X4DVPROC =
    CFuncPtr4[GLint, GLsizei, GLboolean, Ptr[GLdouble], Unit]
  type PFNGLUNIFORMMATRIX4X2DVPROC =
    CFuncPtr4[GLint, GLsizei, GLboolean, Ptr[GLdouble], Unit]
  type PFNGLUNIFORMMATRIX4X3DVPROC =
    CFuncPtr4[GLint, GLsizei, GLboolean, Ptr[GLdouble], Unit]
  type PFNGLGETUNIFORMDVPROC = CFuncPtr3[GLuint, GLint, Ptr[GLdouble], Unit]
  type PFNGLGETSUBROUTINEUNIFORMLOCATIONPROC =
    CFuncPtr3[GLuint, GLenum, Ptr[GLchar], GLint]
  type PFNGLGETSUBROUTINEINDEXPROC =
    CFuncPtr3[GLuint, GLenum, Ptr[GLchar], GLuint]
  type PFNGLGETACTIVESUBROUTINEUNIFORMIVPROC =
    CFuncPtr5[GLuint, GLenum, GLuint, GLenum, Ptr[GLint], Unit]
  type PFNGLGETACTIVESUBROUTINEUNIFORMNAMEPROC =
    CFuncPtr6[GLuint, GLenum, GLuint, GLsizei, Ptr[GLsizei], Ptr[GLchar], Unit]
  type PFNGLGETACTIVESUBROUTINENAMEPROC =
    CFuncPtr6[GLuint, GLenum, GLuint, GLsizei, Ptr[GLsizei], Ptr[GLchar], Unit]
  type PFNGLUNIFORMSUBROUTINESUIVPROC =
    CFuncPtr3[GLenum, GLsizei, Ptr[GLuint], Unit]
  type PFNGLGETUNIFORMSUBROUTINEUIVPROC =
    CFuncPtr3[GLenum, GLint, Ptr[GLuint], Unit]
  type PFNGLGETPROGRAMSTAGEIVPROC =
    CFuncPtr4[GLuint, GLenum, GLenum, Ptr[GLint], Unit]
  ...
  type PFNGLDRAWTRANSFORMFEEDBACKSTREAMPROC =
    CFuncPtr3[GLenum, GLuint, GLuint, Unit]
  ...
  type PFNGLGETQUERYINDEXEDIVPROC =
    CFuncPtr4[GLenum, GLuint, GLenum, Ptr[GLint], Unit]
  ...
  def glBeginQueryIndexed(target: GLenum, index: GLuint, id: GLuint): Unit =
    extern
  ...
  type PFNGLSHADERBINARYPROC =
    CFuncPtr5[GLsizei, Ptr[GLuint], GLenum, Ptr[Byte], GLsizei, Unit]
  type PFNGLGETSHADERPRECISIONFORMATPROC =
    CFuncPtr4[GLenum, GLenum, Ptr[GLint], Ptr[GLint], Unit]
  ...
  type PFNGLGETPROGRAMBINARYPROC =
    CFuncPtr5[GLuint, GLsizei, Ptr[GLsizei], Ptr[GLenum], Ptr[Byte], Unit]
  type PFNGLPROGRAMBINARYPROC =
    CFuncPtr4[GLuint, GLenum, Ptr[Byte], GLsizei, Unit]
  ...
  type PFNGLCREATESHADERPROGRAMVPROC =
    CFuncPtr3[GLenum, GLsizei, Ptr[Ptr[GLchar]], GLuint]
  ...
  type PFNGLGETPROGRAMPIPELINEIVPROC =
    CFuncPtr3[GLuint, GLenum, Ptr[GLint], Unit]
  type PFNGLPROGRAMUNIFORM1IPROC = CFuncPtr3[GLuint, GLint, GLint, Unit]
  type PFNGLPROGRAMUNIFORM1IVPROC =
    CFuncPtr4[GLuint, GLint, GLsizei, Ptr[GLint], Unit]
  type PFNGLPROGRAMUNIFORM1FPROC = CFuncPtr3[GLuint, GLint, GLfloat, Unit]
  type PFNGLPROGRAMUNIFORM1FVPROC =
    CFuncPtr4[GLuint, GLint, GLsizei, Ptr[GLfloat], Unit]
  type PFNGLPROGRAMUNIFORM1DPROC = CFuncPtr3[GLuint, GLint, GLdouble, Unit]
  type PFNGLPROGRAMUNIFORM1DVPROC =
    CFuncPtr4[GLuint, GLint, GLsizei, Ptr[GLdouble], Unit]
  type PFNGLPROGRAMUNIFORM1UIPROC = CFuncPtr3[GLuint, GLint, GLuint, Unit]
  type PFNGLPROGRAMUNIFORM1UIVPROC =
    CFuncPtr4[GLuint, GLint, GLsizei, Ptr[GLuint], Unit]
  type PFNGLPROGRAMUNIFORM2IPROC = CFuncPtr4[GLuint, GLint, GLint, GLint, Unit]
  type PFNGLPROGRAMUNIFORM2IVPROC =
    CFuncPtr4[GLuint, GLint, GLsizei, Ptr[GLint], Unit]
  type PFNGLPROGRAMUNIFORM2FPROC =
    CFuncPtr4[GLuint, GLint, GLfloat, GLfloat, Unit]
  type PFNGLPROGRAMUNIFORM2FVPROC =
    CFuncPtr4[GLuint, GLint, GLsizei, Ptr[GLfloat], Unit]
  type PFNGLPROGRAMUNIFORM2DPROC =
    CFuncPtr4[GLuint, GLint, GLdouble, GLdouble, Unit]
  type PFNGLPROGRAMUNIFORM2DVPROC =
    CFuncPtr4[GLuint, GLint, GLsizei, Ptr[GLdouble], Unit]
  type PFNGLPROGRAMUNIFORM2UIPROC =
    CFuncPtr4[GLuint, GLint, GLuint, GLuint, Unit]
  type PFNGLPROGRAMUNIFORM2UIVPROC =
    CFuncPtr4[GLuint, GLint, GLsizei, Ptr[GLuint], Unit]
  type PFNGLPROGRAMUNIFORM3IPROC =
    CFuncPtr5[GLuint, GLint, GLint, GLint, GLint, Unit]
  type PFNGLPROGRAMUNIFORM3IVPROC =
    CFuncPtr4[GLuint, GLint, GLsizei, Ptr[GLint], Unit]
  type PFNGLPROGRAMUNIFORM3FPROC =
    CFuncPtr5[GLuint, GLint, GLfloat, GLfloat, GLfloat, Unit]
  type PFNGLPROGRAMUNIFORM3FVPROC =
    CFuncPtr4[GLuint, GLint, GLsizei, Ptr[GLfloat], Unit]
  type PFNGLPROGRAMUNIFORM3DPROC =
    CFuncPtr5[GLuint, GLint, GLdouble, GLdouble, GLdouble, Unit]
  type PFNGLPROGRAMUNIFORM3DVPROC =
    CFuncPtr4[GLuint, GLint, GLsizei, Ptr[GLdouble], Unit]
  type PFNGLPROGRAMUNIFORM3UIPROC =
    CFuncPtr5[GLuint, GLint, GLuint, GLuint, GLuint, Unit]
  type PFNGLPROGRAMUNIFORM3UIVPROC =
    CFuncPtr4[GLuint, GLint, GLsizei, Ptr[GLuint], Unit]
  type PFNGLPROGRAMUNIFORM4IPROC =
    CFuncPtr6[GLuint, GLint, GLint, GLint, GLint, GLint, Unit]
  type PFNGLPROGRAMUNIFORM4IVPROC =
    CFuncPtr4[GLuint, GLint, GLsizei, Ptr[GLint], Unit]
  type PFNGLPROGRAMUNIFORM4FPROC =
    CFuncPtr6[GLuint, GLint, GLfloat, GLfloat, GLfloat, GLfloat, Unit]
  type PFNGLPROGRAMUNIFORM4FVPROC =
    CFuncPtr4[GLuint, GLint, GLsizei, Ptr[GLfloat], Unit]
  type PFNGLPROGRAMUNIFORM4DPROC =
    CFuncPtr6[GLuint, GLint, GLdouble, GLdouble, GLdouble, GLdouble, Unit]
  type PFNGLPROGRAMUNIFORM4DVPROC =
    CFuncPtr4[GLuint, GLint, GLsizei, Ptr[GLdouble], Unit]
  type PFNGLPROGRAMUNIFORM4UIPROC =
    CFuncPtr6[GLuint, GLint, GLuint, GLuint, GLuint, GLuint, Unit]
  type PFNGLPROGRAMUNIFORM4UIVPROC =
    CFuncPtr4[GLuint, GLint, GLsizei, Ptr[GLuint], Unit]
  type PFNGLPROGRAMUNIFORMMATRIX2FVPROC =
    CFuncPtr5[GLuint, GLint, GLsizei, GLboolean, Ptr[GLfloat], Unit]
  type PFNGLPROGRAMUNIFORMMATRIX3FVPROC =
    CFuncPtr5[GLuint, GLint, GLsizei, GLboolean, Ptr[GLfloat], Unit]
  type PFNGLPROGRAMUNIFORMMATRIX4FVPROC =
    CFuncPtr5[GLuint, GLint, GLsizei, GLboolean, Ptr[GLfloat], Unit]
  type PFNGLPROGRAMUNIFORMMATRIX2DVPROC =
    CFuncPtr5[GLuint, GLint, GLsizei, GLboolean, Ptr[GLdouble], Unit]
  type PFNGLPROGRAMUNIFORMMATRIX3DVPROC =
    CFuncPtr5[GLuint, GLint, GLsizei, GLboolean, Ptr[GLdouble], Unit]
  type PFNGLPROGRAMUNIFORMMATRIX4DVPROC =
    CFuncPtr5[GLuint, GLint, GLsizei, GLboolean, Ptr[GLdouble], Unit]
  type PFNGLPROGRAMUNIFORMMATRIX2X3FVPROC =
    CFuncPtr5[GLuint, GLint, GLsizei, GLboolean, Ptr[GLfloat], Unit]
  type PFNGLPROGRAMUNIFORMMATRIX3X2FVPROC =
    CFuncPtr5[GLuint, GLint, GLsizei, GLboolean, Ptr[GLfloat], Unit]
  type PFNGLPROGRAMUNIFORMMATRIX2X4FVPROC =
    CFuncPtr5[GLuint, GLint, GLsizei, GLboolean, Ptr[GLfloat], Unit]
  type PFNGLPROGRAMUNIFORMMATRIX4X2FVPROC =
    CFuncPtr5[GLuint, GLint, GLsizei, GLboolean, Ptr[GLfloat], Unit]
  type PFNGLPROGRAMUNIFORMMATRIX3X4FVPROC =
    CFuncPtr5[GLuint, GLint, GLsizei, GLboolean, Ptr[GLfloat], Unit]
  type PFNGLPROGRAMUNIFORMMATRIX4X3FVPROC =
    CFuncPtr5[GLuint, GLint, GLsizei, GLboolean, Ptr[GLfloat], Unit]
  type PFNGLPROGRAMUNIFORMMATRIX2X3DVPROC =
    CFuncPtr5[GLuint, GLint, GLsizei, GLboolean, Ptr[GLdouble], Unit]
  type PFNGLPROGRAMUNIFORMMATRIX3X2DVPROC =
    CFuncPtr5[GLuint, GLint, GLsizei, GLboolean, Ptr[GLdouble], Unit]
  type PFNGLPROGRAMUNIFORMMATRIX2X4DVPROC =
    CFuncPtr5[GLuint, GLint, GLsizei, GLboolean, Ptr[GLdouble], Unit]
  type PFNGLPROGRAMUNIFORMMATRIX4X2DVPROC =
    CFuncPtr5[GLuint, GLint, GLsizei, GLboolean, Ptr[GLdouble], Unit]
  type PFNGLPROGRAMUNIFORMMATRIX3X4DVPROC =
    CFuncPtr5[GLuint, GLint, GLsizei, GLboolean, Ptr[GLdouble], Unit]
  type PFNGLPROGRAMUNIFORMMATRIX4X3DVPROC =
    CFuncPtr5[GLuint, GLint, GLsizei, GLboolean, Ptr[GLdouble], Unit]
  type PFNGLVALIDATEPROGRAMPIPELINEPROC = CFuncPtr1[GLuint, Unit]
  type PFNGLGETPROGRAMPIPELINEINFOLOGPROC =
    CFuncPtr4[GLuint, GLsizei, Ptr[GLsizei], Ptr[GLchar], Unit]
  ...
  type PFNGLVERTEXATTRIBL3DPROC =
    CFuncPtr4[GLuint, GLdouble, GLdouble, GLdouble, Unit]
  type PFNGLVERTEXATTRIBL4DPROC =
    CFuncPtr5[GLuint, GLdouble, GLdouble, GLdouble, GLdouble, Unit]
  ...
  type PFNGLVERTEXATTRIBLPOINTERPROC =
    CFuncPtr5[GLuint, GLint, GLenum, GLsizei, Ptr[Byte], Unit]
  type PFNGLGETVERTEXATTRIBLDVPROC =
    CFuncPtr3[GLuint, GLenum, Ptr[GLdouble], Unit]
  type PFNGLVIEWPORTARRAYVPROC = CFuncPtr3[GLuint, GLsizei, Ptr[GLfloat], Unit]
  type PFNGLVIEWPORTINDEXEDFPROC =
    CFuncPtr5[GLuint, GLfloat, GLfloat, GLfloat, GLfloat, Unit]
  ...
  type PFNGLSCISSORINDEXEDPROC =
    CFuncPtr5[GLuint, GLint, GLint, GLsizei, GLsizei, Unit]
  type PFNGLSCISSORINDEXEDVPROC = CFuncPtr2[GLuint, Ptr[GLint], Unit]
  type PFNGLDEPTHRANGEARRAYVPROC =
    CFuncPtr3[GLuint, GLsizei, Ptr[GLdouble], Unit]
  ...
  def glProgramParameteri(program: GLuint, pname: GLenum, value: GLint): Unit =
    extern
  ...
  def glCreateShaderProgramv(
      type_ : GLenum,
      count: GLsizei,
      strings: Ptr[Ptr[GLchar]]
  ): GLuint = extern
  def glBindProgramPipeline(pipeline: GLuint): Unit = extern
  def glDeleteProgramPipelines(n: GLsizei, pipelines: Ptr[GLuint]): Unit =
    extern
  ...
  def glProgramUniform1i(program: GLuint, location: GLint, v0: GLint): Unit =
    extern
  ...
  def glProgramUniform1f(program: GLuint, location: GLint, v0: GLfloat): Unit =
    extern
  ...
  def glProgramUniform1d(program: GLuint, location: GLint, v0: GLdouble): Unit =
    extern
  ...
  def glProgramUniform1ui(program: GLuint, location: GLint, v0: GLuint): Unit =
    extern
  ...
  def glViewportArrayv(first: GLuint, count: GLsizei, v: Ptr[GLfloat]): Unit =
    extern
  ...
  def glScissorArrayv(first: GLuint, count: GLsizei, v: Ptr[GLint]): Unit =
    extern
  ...
  def glDepthRangeIndexed(index: GLuint, n: GLdouble, f: GLdouble): Unit =
    extern
  def glGetFloati_v(target: GLenum, index: GLuint, data: Ptr[GLfloat]): Unit =
    extern
  def glGetDoublei_v(target: GLenum, index: GLuint, data: Ptr[GLdouble]): Unit =
    extern
  /*
   * End OpenGL 4.1
   */
   ...
   * OpenGL 4.2
   */
  type PFNGLDRAWARRAYSINSTANCEDBASEINSTANCEPROC =
    CFuncPtr5[GLenum, GLint, GLsizei, GLsizei, GLuint, Unit]
  type PFNGLDRAWELEMENTSINSTANCEDBASEINSTANCEPROC =
    CFuncPtr6[GLenum, GLsizei, GLenum, Ptr[Byte], GLsizei, GLuint, Unit]
  type PFNGLDRAWELEMENTSINSTANCEDBASEVERTEXBASEINSTANCEPROC =
    CFuncPtr7[GLenum, GLsizei, GLenum, Ptr[Byte], GLsizei, GLint, GLuint, Unit]
  type PFNGLGETINTERNALFORMATIVPROC =
    CFuncPtr5[GLenum, GLenum, GLenum, GLsizei, Ptr[GLint], Unit]
  type PFNGLGETACTIVEATOMICCOUNTERBUFFERIVPROC =
    CFuncPtr4[GLuint, GLuint, GLenum, Ptr[GLint], Unit]
  type PFNGLBINDIMAGETEXTUREPROC =
    CFuncPtr7[GLuint, GLuint, GLint, GLboolean, GLint, GLenum, GLenum, Unit]
  ...
  type PFNGLTEXSTORAGE3DPROC =
    CFuncPtr6[GLenum, GLsizei, GLenum, GLsizei, GLsizei, GLsizei, Unit]
  type PFNGLDRAWTRANSFORMFEEDBACKINSTANCEDPROC =
    CFuncPtr3[GLenum, GLuint, GLsizei, Unit]
  type PFNGLDRAWTRANSFORMFEEDBACKSTREAMINSTANCEDPROC =
    CFuncPtr4[GLenum, GLuint, GLuint, GLsizei, Unit]
   ...
   * OpenGL 4.3
   */
  type GLDEBUGPROC = CFuncPtr7[GLenum, GLenum, GLuint, GLenum, GLsizei, Ptr[
    GLchar
  ], Ptr[Byte], Ptr[Byte]]

  type PFNGLCLEARBUFFERDATAPROC =
    CFuncPtr5[GLenum, GLenum, GLenum, GLenum, Ptr[Byte], Unit]
  type PFNGLCLEARBUFFERSUBDATAPROC =
    CFuncPtr7[GLenum, GLenum, GLintptr, GLsizeiptr, GLenum, GLenum, Ptr[
      Byte
    ], Unit]
  ...
  type PFNGLCOPYIMAGESUBDATAPROC = CFuncPtr15[
    GLuint,
    GLenum,
    GLint,
    GLint,
  ...
  type PFNGLGETFRAMEBUFFERPARAMETERIVPROC =
    CFuncPtr3[GLenum, GLenum, Ptr[GLint], Unit]
  type PFNGLGETINTERNALFORMATI64VPROC =
    CFuncPtr5[GLenum, GLenum, GLenum, GLsizei, Ptr[GLint64], Unit]
  type PFNGLINVALIDATETEXSUBIMAGEPROC = CFuncPtr8[
    GLuint,
    GLint,
    GLint,
    GLint,
  ...
  type PFNGLINVALIDATEBUFFERSUBDATAPROC =
    CFuncPtr3[GLuint, GLintptr, GLsizeiptr, Unit]
  type PFNGLINVALIDATEBUFFERDATAPROC = CFuncPtr1[GLuint, Unit]
  type PFNGLINVALIDATEFRAMEBUFFERPROC =
    CFuncPtr3[GLenum, GLsizei, Ptr[GLenum], Unit]
  type PFNGLINVALIDATESUBFRAMEBUFFERPROC = CFuncPtr7[GLenum, GLsizei, Ptr[
    GLenum
  ], GLint, GLint, GLsizei, GLsizei, Unit]
  type PFNGLMULTIDRAWARRAYSINDIRECTPROC =
    CFuncPtr4[GLenum, Ptr[Byte], GLsizei, GLsizei, Unit]
  type PFNGLMULTIDRAWELEMENTSINDIRECTPROC =
    CFuncPtr5[GLenum, GLenum, Ptr[Byte], GLsizei, GLsizei, Unit]
  type PFNGLGETPROGRAMINTERFACEIVPROC =
    CFuncPtr4[GLuint, GLenum, GLenum, Ptr[GLint], Unit]
  type PFNGLGETPROGRAMRESOURCEINDEXPROC =
    CFuncPtr3[GLuint, GLenum, Ptr[GLchar], Unit]
  type PFNGLGETPROGRAMRESOURCENAMEPROC =
    CFuncPtr6[GLuint, GLenum, GLuint, GLsizei, Ptr[GLsizei], Ptr[GLchar], Unit]
  type PFNGLGETPROGRAMRESOURCEIVPROC =
    CFuncPtr8[GLuint, GLenum, GLuint, GLsizei, Ptr[GLenum], GLsizei, Ptr[
      GLsizei
    ], Ptr[GLint], Unit]
  type PFNGLGETPROGRAMRESOURCELOCATIONPROC =
    CFuncPtr3[GLuint, GLenum, Ptr[GLchar], Unit]
  type PFNGLGETPROGRAMRESOURCELOCATIONINDEXPROC =
    CFuncPtr3[GLuint, GLenum, Ptr[GLchar], Unit]
  type PFNGLSHADERSTORAGEBLOCKBINDINGPROC =
    CFuncPtr3[GLuint, GLuint, GLuint, Unit]
  type PFNGLTEXBUFFERRANGEPROC =
    CFuncPtr5[GLenum, GLenum, GLuint, GLintptr, GLsizeiptr, Unit]
  type PFNGLTEXSTORAGE2DMULTISAMPLEPROC =
    CFuncPtr6[GLenum, GLsizei, GLenum, GLsizei, GLsizei, GLboolean, Unit]
  type PFNGLTEXSTORAGE3DMULTISAMPLEPROC = CFuncPtr7[
    GLenum,
    GLsizei,
    GLenum,
    GLsizei,
  ...
  type PFNGLTEXTUREVIEWPROC = CFuncPtr8[
    GLuint,
    GLenum,
    GLuint,
    GLenum,
  ...
  type PFNGLBINDVERTEXBUFFERPROC =
    CFuncPtr4[GLuint, GLuint, GLintptr, GLsizei, Unit]
  type PFNGLVERTEXATTRIBFORMATPROC =
    CFuncPtr5[GLuint, GLint, GLenum, GLboolean, GLuint, Unit]
  type PFNGLVERTEXATTRIBIFORMATPROC =
    CFuncPtr4[GLuint, GLint, GLenum, GLuint, Unit]
  type PFNGLVERTEXATTRIBLFORMATPROC =
    CFuncPtr4[GLuint, GLint, GLenum, GLuint, Unit]
  ...
  type PFNGLDEBUGMESSAGECONTROLPROC =
    CFuncPtr6[GLenum, GLenum, GLenum, GLsizei, Ptr[GLuint], GLboolean, Unit]
  type PFNGLDEBUGMESSAGEINSERTPROC =
    CFuncPtr6[GLenum, GLenum, GLuint, GLenum, GLsizei, Ptr[GLchar], Unit]
  type PFNGLDEBUGMESSAGECALLBACKPROC = CFuncPtr2[GLDEBUGPROC, Ptr[Byte], Unit]
  type PFNGLGETDEBUGMESSAGELOGPROC = CFuncPtr8[GLuint, GLsizei, Ptr[
    GLenum
  ], Ptr[GLenum], Ptr[GLuint], Ptr[GLenum], Ptr[GLsizei], Ptr[GLchar], Unit]
  type PFNGLPUSHDEBUGGROUPPROC =
    CFuncPtr4[GLenum, GLuint, GLsizei, Ptr[GLchar], Unit]
  type PFNGLPOPDEBUGGROUPPROC = CFuncPtr1[Unit, Unit]
  type PFNGLOBJECTLABELPROC =
    CFuncPtr4[GLenum, GLuint, GLsizei, Ptr[GLchar], Unit]
  type PFNGLGETOBJECTLABELPROC =
    CFuncPtr5[GLenum, GLuint, GLsizei, Ptr[GLsizei], Ptr[GLchar], Unit]
  type PFNGLOBJECTPTRLABELPROC =
    CFuncPtr3[Ptr[Byte], GLsizei, Ptr[GLchar], Unit]
  type PFNGLGETOBJECTPTRLABELPROC =
    CFuncPtr4[Ptr[Byte], GLsizei, Ptr[GLsizei], Ptr[GLchar], Unit]
  ...
  def glMultiDrawElementsIndirect(
      mode: GLenum,
      type_ : GLenum,
      indirect: Ptr[Byte],
      drawcount: GLsizei,
  ...
  def glVertexAttribBinding(attribindex: GLuint, bindingindex: GLuint): Unit =
    extern
  def glVertexBindingDivisor(bindingindex: GLuint, divisor: GLuint): Unit =
    extern
  ...
  def glGetDebugMessageLog(
      ...
      types: Ptr[GLenum],
      ids: Ptr[GLuint],
      severities: Ptr[GLenum],
      lengths: Ptr[GLsizei],
      messageLog: Ptr[GLchar]
  ): GLuint = extern
  ...
  def glObjectPtrLabel(
      ptr: Ptr[Byte],
      length: GLsizei,
      label: Ptr[GLchar]
  ): Unit = extern
  def glGetObjectPtrLabel(
      ptr: Ptr[Byte],
      bufSize: GLsizei,
      length: GLsizei,
      label: GLchar
   ...
   * OpenGL 4.4
   */
  type PFNGLBUFFERSTORAGEPROC =
    CFuncPtr4[GLenum, GLsizeiptr, Ptr[Byte], GLbitfield, Unit]
  type PFNGLCLEARTEXIMAGEPROC =
    CFuncPtr5[GLuint, GLint, GLenum, GLenum, Ptr[Byte], Unit]
  type PFNGLCLEARTEXSUBIMAGEPROC = CFuncPtr11[
    GLuint,
    GLint,
    GLint,
    GLint,
  ...
  type PFNGLBINDBUFFERSBASEPROC =
    CFuncPtr4[GLenum, GLuint, GLsizei, Ptr[GLuint], Unit]
  type PFNGLBINDBUFFERSRANGEPROC = CFuncPtr6[GLenum, GLuint, GLsizei, Ptr[
    GLuint
  ], Ptr[GLintptr], Ptr[GLsizeiptr], Unit]
  ...
  type PFNGLBINDIMAGETEXTURESPROC =
    CFuncPtr3[GLuint, GLsizei, Ptr[GLuint], Unit]
  type PFNGLBINDVERTEXBUFFERSPROC =
    CFuncPtr5[GLuint, GLsizei, Ptr[GLuint], Ptr[GLintptr], Ptr[GLsizei], Unit]
  ...
  type PFNGLTRANSFORMFEEDBACKBUFFERBASEPROC =
    CFuncPtr3[GLuint, GLuint, GLuint, Unit]
  type PFNGLTRANSFORMFEEDBACKBUFFERRANGEPROC =
    CFuncPtr5[GLuint, GLuint, GLuint, GLintptr, GLsizeiptr, Unit]
  type PFNGLGETTRANSFORMFEEDBACKIVPROC =
    CFuncPtr3[GLuint, GLenum, Ptr[GLint], Unit]
  type PFNGLGETTRANSFORMFEEDBACKI_VPROC =
    CFuncPtr4[GLuint, GLenum, GLuint, Ptr[GLint], Unit]
  type PFNGLGETTRANSFORMFEEDBACKI64_VPROC =
    CFuncPtr4[GLuint, GLenum, GLuint, Ptr[GLint64], Unit]
  type PFNGLCREATEBUFFERSPROC = CFuncPtr2[GLsizei, Ptr[GLuint], Unit]
  type PFNGLNAMEDBUFFERSTORAGEPROC =
    CFuncPtr4[GLuint, GLsizeiptr, Ptr[Byte], GLbitfield, Unit]
  type PFNGLNAMEDBUFFERDATAPROC =
    CFuncPtr4[GLuint, GLsizeiptr, Ptr[Byte], GLenum, Unit]
  type PFNGLNAMEDBUFFERSUBDATAPROC =
    CFuncPtr4[GLuint, GLintptr, GLsizeiptr, Ptr[Byte], Unit]
  type PFNGLCOPYNAMEDBUFFERSUBDATAPROC =
    CFuncPtr5[GLuint, GLuint, GLintptr, GLintptr, GLsizeiptr, Unit]
  type PFNGLCLEARNAMEDBUFFERDATAPROC =
    CFuncPtr5[GLuint, GLenum, GLenum, GLenum, Ptr[Byte], Unit]
  type PFNGLCLEARNAMEDBUFFERSUBDATAPROC =
    CFuncPtr7[GLuint, GLenum, GLintptr, GLsizeiptr, GLenum, GLenum, Ptr[
      Byte
    ], Unit]
  type PFNGLMAPNAMEDBUFFERPROC = CFuncPtr2[GLuint, GLenum, Ptr[Byte]]
  type PFNGLMAPNAMEDBUFFERRANGEPROC =
    CFuncPtr4[GLuint, GLintptr, GLsizeiptr, GLbitfield, Ptr[Byte]]
  type PFNGLUNMAPNAMEDBUFFERPROC = CFuncPtr1[GLuint, GLboolean]
  type PFNGLFLUSHMAPPEDNAMEDBUFFERRANGEPROC =
    CFuncPtr3[GLuint, GLintptr, GLsizeiptr, Unit]
  type PFNGLGETNAMEDBUFFERPARAMETERIVPROC =
    CFuncPtr3[GLuint, GLenum, Ptr[GLint], Unit]
  type PFNGLGETNAMEDBUFFERPARAMETERI64VPROC =
    CFuncPtr3[GLuint, GLenum, Ptr[GLint64], Unit]
  type PFNGLGETNAMEDBUFFERPOINTERVPROC =
    CFuncPtr3[GLuint, GLenum, Ptr[Ptr[Byte]], Unit]
  type PFNGLGETNAMEDBUFFERSUBDATAPROC =
    CFuncPtr4[GLuint, GLintptr, GLsizeiptr, Ptr[Byte], Unit]
  type PFNGLCREATEFRAMEBUFFERSPROC = CFuncPtr2[GLsizei, Ptr[GLuint], Unit]
  type PFNGLNAMEDFRAMEBUFFERRENDERBUFFERPROC =
    CFuncPtr4[GLuint, GLenum, GLenum, GLuint, Unit]
  type PFNGLNAMEDFRAMEBUFFERPARAMETERIPROC =
    CFuncPtr3[GLuint, GLenum, GLint, Unit]
  type PFNGLNAMEDFRAMEBUFFERTEXTUREPROC =
    CFuncPtr4[GLuint, GLenum, GLuint, GLint, Unit]
  type PFNGLNAMEDFRAMEBUFFERTEXTURELAYERPROC =
    CFuncPtr5[GLuint, GLenum, GLuint, GLint, GLint, Unit]
  type PFNGLNAMEDFRAMEBUFFERDRAWBUFFERPROC = CFuncPtr2[GLuint, GLenum, Unit]
  type PFNGLNAMEDFRAMEBUFFERDRAWBUFFERSPROC =
    CFuncPtr3[GLuint, GLsizei, Ptr[GLenum], Unit]
  type PFNGLNAMEDFRAMEBUFFERREADBUFFERPROC = CFuncPtr2[GLuint, GLenum, Unit]
  type PFNGLINVALIDATENAMEDFRAMEBUFFERDATAPROC =
    CFuncPtr3[GLuint, GLsizei, Ptr[GLenum], Unit]
  type PFNGLINVALIDATENAMEDFRAMEBUFFERSUBDATAPROC =
    CFuncPtr7[GLuint, GLsizei, Ptr[
      GLenum
    ], GLint, GLint, GLsizei, GLsizei, Unit]
  type PFNGLCLEARNAMEDFRAMEBUFFERIVPROC =
    CFuncPtr4[GLuint, GLenum, GLint, Ptr[GLint], Unit]
  type PFNGLCLEARNAMEDFRAMEBUFFERUIVPROC =
    CFuncPtr4[GLuint, GLenum, GLint, Ptr[GLuint], Unit]
  type PFNGLCLEARNAMEDFRAMEBUFFERFVPROC =
    CFuncPtr4[GLuint, GLenum, GLint, Ptr[GLfloat], Unit]
  type PFNGLCLEARNAMEDFRAMEBUFFERFIPROC =
    CFuncPtr5[GLuint, GLenum, GLint, GLfloat, GLint, Unit]
  type PFNGLBLITNAMEDFRAMEBUFFERPROC = CFuncPtr12[
    GLuint,
    GLuint,
    GLint,
    GLint,
  ...
  type PFNGLGETNAMEDFRAMEBUFFERPARAMETERIVPROC =
    CFuncPtr3[GLuint, GLenum, Ptr[GLint], Unit]
  type PFNGLGETNAMEDFRAMEBUFFERATTACHMENTPARAMETERIVPROC =
    CFuncPtr4[GLuint, GLenum, GLenum, Ptr[GLint], Unit]
  type PFNGLCREATERENDERBUFFERSPROC = CFuncPtr2[GLsizei, Ptr[GLuint], Unit]
  type PFNGLNAMEDRENDERBUFFERSTORAGEPROC =
    CFuncPtr4[GLuint, GLenum, GLsizei, GLsizei, Unit]
  type PFNGLNAMEDRENDERBUFFERSTORAGEMULTISAMPLEPROC =
    CFuncPtr5[GLuint, GLsizei, GLenum, GLsizei, GLsizei, Unit]
  type PFNGLGETNAMEDRENDERBUFFERPARAMETERIVPROC =
    CFuncPtr3[GLuint, GLenum, Ptr[GLint], Unit]
  ...
  type PFNGLTEXTUREBUFFERRANGEPROC =
    CFuncPtr5[GLuint, GLenum, GLuint, GLintptr, GLsizeiptr, Unit]
  type PFNGLTEXTURESTORAGE1DPROC =
    CFuncPtr4[GLuint, GLsizei, GLenum, GLsizei, Unit]
  type PFNGLTEXTURESTORAGE2DPROC =
    CFuncPtr5[GLuint, GLsizei, GLenum, GLsizei, GLsizei, Unit]
  type PFNGLTEXTURESTORAGE3DPROC =
    CFuncPtr6[GLuint, GLsizei, GLenum, GLsizei, GLsizei, GLsizei, Unit]
  type PFNGLTEXTURESTORAGE2DMULTISAMPLEPROC =
    CFuncPtr6[GLuint, GLsizei, GLenum, GLsizei, GLsizei, GLboolean, Unit]
  type PFNGLTEXTURESTORAGE3DMULTISAMPLEPROC = CFuncPtr7[
    GLuint,
    GLsizei,
    GLenum,
    GLsizei,
  ...
  type PFNGLTEXTURESUBIMAGE1DPROC =
    CFuncPtr7[GLuint, GLint, GLint, GLsizei, GLenum, GLenum, Ptr[Byte], Unit]
  type PFNGLTEXTURESUBIMAGE2DPROC = CFuncPtr9[
    GLuint,
    GLint,
    GLint,
    GLint,
  ...
  type PFNGLTEXTURESUBIMAGE3DPROC = CFuncPtr11[
    GLuint,
    GLint,
    GLint,
    GLint,
  ...
  type PFNGLCOMPRESSEDTEXTURESUBIMAGE1DPROC =
    CFuncPtr7[GLuint, GLint, GLint, GLsizei, GLenum, GLsizei, Ptr[Byte], Unit]
  type PFNGLCOMPRESSEDTEXTURESUBIMAGE2DPROC = CFuncPtr9[
    GLuint,
    GLint,
    GLint,
    GLint,
  ...
  type PFNGLCOMPRESSEDTEXTURESUBIMAGE3DPROC = CFuncPtr11[
    GLuint,
    GLint,
    GLint,
    GLint,
  ...
  type PFNGLCOPYTEXTURESUBIMAGE1DPROC =
    CFuncPtr6[GLuint, GLint, GLint, GLint, GLint, GLsizei, Unit]
  type PFNGLCOPYTEXTURESUBIMAGE2DPROC =
    CFuncPtr8[GLuint, GLint, GLint, GLint, GLint, GLint, GLsizei, GLsizei, Unit]
  type PFNGLCOPYTEXTURESUBIMAGE3DPROC = CFuncPtr9[
    GLuint,
    GLint,
    GLint,
    GLint,
  ...
  type PFNGLTEXTUREPARAMETERFVPROC =
    CFuncPtr3[GLuint, GLenum, Ptr[GLfloat], Unit]
  type PFNGLTEXTUREPARAMETERIPROC = CFuncPtr3[GLuint, GLenum, GLint, Unit]
  type PFNGLTEXTUREPARAMETERIIVPROC =
    CFuncPtr3[GLuint, GLenum, Ptr[GLint], Unit]
  type PFNGLTEXTUREPARAMETERIUIVPROC =
    CFuncPtr3[GLuint, GLenum, Ptr[GLuint], Unit]
  ...
  type PFNGLGETTEXTUREIMAGEPROC =
    CFuncPtr6[GLuint, GLint, GLenum, GLenum, GLsizei, Ptr[Byte], Unit]
  type PFNGLGETCOMPRESSEDTEXTUREIMAGEPROC =
    CFuncPtr4[GLuint, GLint, GLsizei, Ptr[Byte], Unit]
  type PFNGLGETTEXTURELEVELPARAMETERFVPROC =
    CFuncPtr4[GLuint, GLint, GLenum, Ptr[GLfloat], Unit]
  type PFNGLGETTEXTURELEVELPARAMETERIVPROC =
    CFuncPtr4[GLuint, GLint, GLenum, Ptr[GLint], Unit]
  type PFNGLGETTEXTUREPARAMETERFVPROC =
    CFuncPtr3[GLuint, GLenum, Ptr[GLfloat], Unit]
  type PFNGLGETTEXTUREPARAMETERIIVPROC =
    CFuncPtr3[GLuint, GLenum, Ptr[GLint], Unit]
  type PFNGLGETTEXTUREPARAMETERIUIVPROC =
    CFuncPtr3[GLuint, GLenum, Ptr[GLuint], Unit]
  type PFNGLGETTEXTUREPARAMETERIVPROC =
    CFuncPtr3[GLuint, GLenum, Ptr[GLint], Unit]
  ...
  type PFNGLVERTEXARRAYVERTEXBUFFERPROC =
    CFuncPtr5[GLuint, GLuint, GLuint, GLintptr, GLsizei, Unit]
  type PFNGLVERTEXARRAYVERTEXBUFFERSPROC =
    CFuncPtr6[GLuint, GLuint, GLsizei, Ptr[GLuint], Ptr[GLintptr], Ptr[
      GLsizei
    ], Unit]
  type PFNGLVERTEXARRAYATTRIBBINDINGPROC =
    CFuncPtr3[GLuint, GLuint, GLuint, Unit]
  type PFNGLVERTEXARRAYATTRIBFORMATPROC =
    CFuncPtr6[GLuint, GLuint, GLint, GLenum, GLboolean, GLuint, Unit]
  type PFNGLVERTEXARRAYATTRIBIFORMATPROC =
    CFuncPtr5[GLuint, GLuint, GLint, GLenum, GLuint, Unit]
  type PFNGLVERTEXARRAYATTRIBLFORMATPROC =
    CFuncPtr5[GLuint, GLuint, GLint, GLenum, GLuint, Unit]
  type PFNGLVERTEXARRAYBINDINGDIVISORPROC =
    CFuncPtr3[GLuint, GLuint, GLuint, Unit]
  type PFNGLGETVERTEXARRAYIVPROC = CFuncPtr3[GLuint, GLenum, Ptr[GLint], Unit]
  type PFNGLGETVERTEXARRAYINDEXEDIVPROC =
    CFuncPtr4[GLuint, GLuint, GLenum, Ptr[GLint], Unit]
  type PFNGLGETVERTEXARRAYINDEXED64IVPROC =
    CFuncPtr4[GLuint, GLuint, GLenum, Ptr[GLint64], Unit]
  ...
  type PFNGLGETQUERYBUFFEROBJECTI64VPROC =
    CFuncPtr4[GLuint, GLuint, GLenum, GLintptr, Unit]
  type PFNGLGETQUERYBUFFEROBJECTIVPROC =
    CFuncPtr4[GLuint, GLuint, GLenum, GLintptr, Unit]
  type PFNGLGETQUERYBUFFEROBJECTUI64VPROC =
    CFuncPtr4[GLuint, GLuint, GLenum, GLintptr, Unit]
  type PFNGLGETQUERYBUFFEROBJECTUIVPROC =
    CFuncPtr4[GLuint, GLuint, GLenum, GLintptr, Unit]
  type PFNGLMEMORYBARRIERBYREGIONPROC = CFuncPtr1[GLbitfield, Unit]
  type PFNGLGETTEXTURESUBIMAGEPROC = CFuncPtr12[
    GLuint,
    GLint,
    GLint,
    GLint,
  ...
  type PFNGLGETCOMPRESSEDTEXTURESUBIMAGEPROC = CFuncPtr10[
    GLuint,
    GLint,
    GLint,
    GLint,
  ...
  type PFNGLGETNCOMPRESSEDTEXIMAGEPROC =
    CFuncPtr4[GLenum, GLint, GLsizei, Ptr[Byte], Unit]
  type PFNGLGETNTEXIMAGEPROC =
    CFuncPtr6[GLenum, GLint, GLenum, GLenum, GLsizei, Ptr[Byte], Unit]
  type PFNGLGETNUNIFORMDVPROC =
    CFuncPtr4[GLuint, GLint, GLsizei, Ptr[GLdouble], Unit]
  type PFNGLGETNUNIFORMFVPROC =
    CFuncPtr4[GLuint, GLint, GLsizei, Ptr[GLfloat], Unit]
  type PFNGLGETNUNIFORMIVPROC =
    CFuncPtr4[GLuint, GLint, GLsizei, Ptr[GLint], Unit]
  type PFNGLGETNUNIFORMUIVPROC =
    CFuncPtr4[GLuint, GLint, GLsizei, Ptr[GLuint], Unit]
  type PFNGLREADNPIXELSPROC =
    CFuncPtr8[GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, GLsizei, Ptr[
      Byte
    ], Unit]
  type PFNGLGETNMAPDVPROC =
    CFuncPtr4[GLenum, GLenum, GLsizei, Ptr[GLdouble], Unit]
  type PFNGLGETNMAPFVPROC =
    CFuncPtr4[GLenum, GLenum, GLsizei, Ptr[GLfloat], Unit]
  ...
  type PFNGLGETNPIXELMAPUSVPROC =
    CFuncPtr3[GLenum, GLsizei, Ptr[GLushort], Unit]
  type PFNGLGETNPOLYGONSTIPPLEPROC = CFuncPtr2[GLsizei, Ptr[GLubyte], Unit]
  type PFNGLGETNCOLORTABLEPROC =
    CFuncPtr5[GLenum, GLenum, GLenum, GLsizei, Ptr[Byte], Unit]
  type PFNGLGETNCONVOLUTIONFILTERPROC =
    CFuncPtr5[GLenum, GLenum, GLenum, GLsizei, Ptr[Byte], Unit]
  type PFNGLGETNSEPARABLEFILTERPROC =
    CFuncPtr8[GLenum, GLenum, GLenum, GLsizei, Ptr[Byte], GLsizei, Ptr[
      Byte
    ], Ptr[Byte], Unit]
  type PFNGLGETNHISTOGRAMPROC =
    CFuncPtr6[GLenum, GLboolean, GLenum, GLenum, GLsizei, Ptr[Byte], Unit]
  type PFNGLGETNMINMAXPROC =
    CFuncPtr6[GLenum, GLboolean, GLenum, GLenum, GLsizei, Ptr[Byte], Unit]
  ...
  def glTransformFeedbackBufferBase(
      xfb: GLuint,
      index: GLuint,
      buffer: GLuint
  ): Unit = extern
  def glTransformFeedbackBufferRange(
      xfb: GLuint,
      index: GLuint,
      buffer: GLuint,
      offset: GLintptr,
  ...
  def glGetTransformFeedbackiv(
      xfb: GLuint,
      pname: GLenum,
      param: Ptr[GLint]
  ): Unit = extern
  def glGetTransformFeedbacki_v(
      xfb: GLuint,
      pname: GLenum,
      index: GLuint,
      param: Ptr[GLint]
  ): Unit = extern
  def glGetTransformFeedbacki64_v(
      xfb: GLuint,
      pname: GLenum,
      index: GLuint,
      param: Ptr[GLint64]
  ...
  def glNamedBufferData(
      buffer: GLuint,
      size: GLsizeiptr,
      data: Ptr[Byte],
      usage: GLenum
  ): Unit = extern
  def glNamedBufferSubData(
      buffer: GLuint,
      offset: GLintptr,
      size: GLsizeiptr,
      data: Ptr[Byte]
  ): Unit = extern
  def glCopyNamedBufferSubData(
      readBuffer: GLuint,
      writeBuffer: GLuint,
      readOffset: GLintptr,
      writeOffset: GLintptr,
  ...
  def glFlushMappedNamedBufferRange(
      buffer: GLuint,
      offset: GLintptr,
      length: GLsizeiptr
  ): Unit = extern
  def glGetNamedBufferParameteriv(
      buffer: GLuint,
      pname: GLenum,
      params: Ptr[GLint]
  ): Unit = extern
  def glGetNamedBufferParameteri64v(
      buffer: GLuint,
      pname: GLenum,
      params: Ptr[GLint64]
  ): Unit = extern
  def glGetNamedBufferPointerv(
      buffer: GLuint,
      pname: GLenum,
      params: Ptr[Ptr[Byte]]
  ): Unit = extern
  def glGetNamedBufferSubData(
      buffer: GLuint,
      offset: GLintptr,
      size: GLsizeiptr,
      data: Ptr[Byte]
  ...
  def glNamedFramebufferDrawBuffer(framebuffer: GLuint, buf: GLenum): Unit =
    extern
  ...
  def glNamedFramebufferReadBuffer(framebuffer: GLuint, src: GLenum): Unit =
    extern
  ...
  def glGetNamedFramebufferParameteriv(
      framebuffer: GLuint,
      pname: GLenum,
      param: Ptr[GLint]
  ): Unit = extern
  def glGetNamedFramebufferAttachmentParameteriv(
      framebuffer: GLuint,
      attachment: GLenum,
      pname: GLenum,
      params: Ptr[GLint]
  ): Unit = extern
  def glCreateRenderbuffers(n: GLsizei, renderbuffers: Ptr[GLuint]): Unit =
    extern
  ...
  def glGetNamedRenderbufferParameteriv(
      renderbuffer: GLuint,
      pname: GLenum,
      params: Ptr[GLint]
  ): Unit = extern
  def glCreateTextures(
      target: GLenum,
      n: GLsizei,
      textures: Ptr[GLuint]
  ): Unit = extern
  ...
  def glTextureParameteri(texture: GLuint, pname: GLenum, param: GLint): Unit =
    extern
  ...
  def glGetTextureLevelParameterfv(
      texture: GLuint,
      level: GLint,
      pname: GLenum,
      params: Ptr[GLfloat]
  ): Unit = extern
  def glGetTextureLevelParameteriv(
      texture: GLuint,
      level: GLint,
      pname: GLenum,
      params: Ptr[GLint]
  ): Unit = extern
  def glGetTextureParameterfv(
      texture: GLuint,
      pname: GLenum,
      params: Ptr[GLfloat]
  ): Unit = extern
  def glGetTextureParameterIiv(
      texture: GLuint,
      pname: GLenum,
      params: Ptr[GLint]
  ): Unit = extern
  def glGetTextureParameterIuiv(
      texture: GLuint,
      pname: GLenum,
      params: Ptr[GLuint]
  ): Unit = extern
  def glGetTextureParameteriv(
      texture: GLuint,
      pname: GLenum,
      params: Ptr[GLint]
  ): Unit = extern
  ...
  def glGetVertexArrayiv(
      vaobj: GLuint,
      pname: GLenum,
      param: Ptr[GLint]
  ): Unit = extern
  def glGetVertexArrayIndexediv(
      vaobj: GLuint,
      index: GLuint,
      pname: GLenum,
      param: Ptr[GLint]
  ): Unit = extern
  def glGetVertexArrayIndexed64iv(
      vaobj: GLuint,
      index: GLuint,
      pname: GLenum,
      param: Ptr[GLint64]
  ...
  def glCreateProgramPipelines(n: GLsizei, pipelines: Ptr[GLuint]): Unit =
    extern
  def glCreateQueries(target: GLenum, n: GLsizei, ids: Ptr[GLuint]): Unit =
    extern
  def glGetQueryBufferObjecti64v(
      id: GLuint,
      buffer: GLuint,
      pname: GLenum,
      offset: GLintptr
  ): Unit = extern
  def glGetQueryBufferObjectiv(
      id: GLuint,
      buffer: GLuint,
      pname: GLenum,
      offset: GLintptr
  ): Unit = extern
  def glGetQueryBufferObjectui64v(
      id: GLuint,
      buffer: GLuint,
      pname: GLenum,
      offset: GLintptr
  ): Unit = extern
  def glGetQueryBufferObjectuiv(
      id: GLuint,
      buffer: GLuint,
      pname: GLenum,
      offset: GLintptr
  ...
  def glGetnPixelMapfv(
      map: GLenum,
      bufSize: GLsizei,
      values: Ptr[GLfloat]
  ): Unit = extern
  def glGetnPixelMapuiv(
      map: GLenum,
      bufSize: GLsizei,
      values: Ptr[GLuint]
  ): Unit = extern
  def glGetnPixelMapusv(
      map: GLenum,
      bufSize: GLsizei,
      values: Ptr[GLushort]
  ): Unit = extern
  def glGetnPolygonStipple(bufSize: GLsizei, pattern: Ptr[GLubyte]): Unit =
    extern
   ...
   * OpenGL 4.6
   */
  type PFNGLSPECIALIZESHADERPROC =
    CFuncPtr5[GLuint, Ptr[GLchar], GLuint, Ptr[GLuint], Ptr[GLuint], Unit]
  type PFNGLMULTIDRAWARRAYSINDIRECTCOUNTPROC =
    CFuncPtr5[GLenum, Ptr[Byte], GLintptr, GLsizei, GLsizei, Unit]
  type PFNGLMULTIDRAWELEMENTSINDIRECTCOUNTPROC =
    CFuncPtr6[GLenum, GLenum, Ptr[Byte], GLintptr, GLsizei, GLsizei, Unit]
  type PFNGLPOLYGONOFFSETCLAMPPROC = CFuncPtr3[GLfloat, GLfloat, GLfloat, Unit]

  def glSpecializeShader(
      shader: GLuint,
      pEntryPoint: Ptr[GLchar],
      numSpecializationConstants: GLuint,
      pConstantIndex: Ptr[GLuint],
      pConstantValue: Ptr[GLuint]
  ): Unit = extern
  def glMultiDrawArraysIndirectCount(
      mode: GLenum,
      indirect: Ptr[Byte],
      drawcount: GLintptr,
  ...
  def glMultiDrawElementsIndirectCount(
      mode: GLenum,
      type_ : GLenum,
      indirect: Ptr[Byte],
      drawcount: GLintptr,
