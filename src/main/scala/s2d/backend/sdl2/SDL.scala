...
object SDL:
  ...
  type SDL_error =
    CStruct2[CInt, CArray[CChar, Nat.Digit3[Nat._1, Nat._2, Nat._8]]]
  ...
  def SDL_MasksToPixelFormatEnum(
      bpp: CInt,
      Rmask: UInt,
      Gmask: UInt,
      Bmask: UInt,
  ...
  type SDL_Surface =
    CStruct12[UInt, Ptr[SDL_PixelFormat], CInt, CInt, CInt, Ptr[Byte], Ptr[
      Byte
  ...
  type SDL_RendererInfo =
    CStruct6[CString, UInt, UInt, CArray[UInt, _16], CInt, CInt]
  ...
  def SDL_GetRendererInfo(
      renderer: Ptr[SDL_Renderer],
      info: Ptr[SDL_RendererInfo]
  ): CInt = extern
  ...
  def SDL_SetTextureBlendMod(
      texture: Ptr[SDL_Texture],
      blendMode: SDL_BlendMode
  ): CInt = extern
  def SDL_GetTextureBlendMod(
      texture: Ptr[SDL_Texture],
  ...
  def SDL_RenderSetLogicalSize(
      renderer: Ptr[SDL_Renderer],
      w: CInt,
      h: CInt
  ): CInt = extern
  def SDL_RenderGetLogicalSize(
      renderer: Ptr[SDL_Renderer],
      w: Ptr[CInt],
      h: Ptr[CInt]
  ): Unit = extern
  def SDL_RenderSetViewport(
      renderer: Ptr[SDL_Renderer],
      rect: Ptr[SDL_Rect]
  ): CInt = extern
  def SDL_RenderGetViewport(
      renderer: Ptr[SDL_Renderer],
      rect: Ptr[SDL_Rect]
  ): Unit = extern

  def SDL_RenderSetClipRect(
      renderer: Ptr[SDL_Renderer],
      rect: Ptr[SDL_Rect]
  ): CInt = extern
  def SDL_RenderGetClipRect(
      renderer: Ptr[SDL_Renderer],
      rect: Ptr[SDL_Rect]
  ): Unit = extern
  def SDL_RenderSetScale(
      renderer: Ptr[SDL_Renderer],
      scaleX: CFloat,
      scaleY: CFloat
  ): CInt = extern
  ...
  def SDL_RenderDrawLines(
      renderer: Ptr[SDL_Renderer],
      points: Ptr[SDL_Point],
      count: CInt
  ): CInt = extern

  def SDL_RenderDrawRect(
      renderer: Ptr[SDL_Renderer],
      rect: Ptr[SDL_Rect]
  ): CInt = extern
  def SDL_RenderDrawRects(
      renderer: Ptr[SDL_Renderer],
      rects: Ptr[SDL_Rect],
      count: CInt
  ): CInt = extern
  ...
  def SDL_SetWindowDisplayMode(
      window: Ptr[SDL_Window],
      mode: Ptr[SDL_DisplayMode]
  ): CInt = extern
  def SDL_GetWindowDisplayMode(
      window: Ptr[SDL_Window],
      mode: Ptr[SDL_DisplayMode]
  ): CInt = extern
  ...
  def SDL_SetWindowOpacity(window: Ptr[SDL_Window], opacity: CFloat): CInt =
    extern
