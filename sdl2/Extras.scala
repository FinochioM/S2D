...
*/
  ...
  val SDL_WINDOWEVENT_SHOWN = 1.toUByte
  val SDL_WINDOWEVENT_HIDDEN = 2.toUByte
  val SDL_WINDOWEVENT_EXPOSED = 3.toUByte
  val SDL_WINDOWEVENT_MOVED = 4.toUByte
  val SDL_WINDOWEVENT_RESIZED = 5.toUByte
  val SDL_WINDOWEVENT_SIZE_CHANGED = 6.toUByte
  val SDL_WINDOWEVENT_MINIMIZED = 7.toUByte
  val SDL_WINDOWEVENT_MAXIMIZED = 8.toUByte
  val SDL_WINDOWEVENT_RESTORED = 9.toUByte
  val SDL_WINDOWEVENT_ENTER = 10.toUByte
  val SDL_WINDOWEVENT_LEAVE = 11.toUByte
  val SDL_WINDOWEVENT_FOCUS_GAINED = 12.toUByte
  val SDL_WINDOWEVENT_FOCUS_LOST = 13.toUByte
  val SDL_WINDOWEVENT_CLOSE = 14.toUByte
